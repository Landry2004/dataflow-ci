...
export default function RapportPage() {
  ...
  if (!fichier) return <div className="p-8">Fichier introuvable</div>;
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b">
                    <th className="text-left py-2 px-3 text-gray-500">Ligne</th>
                    <th className="text-left py-2 px-3 text-gray-500">Colonne</th>
                    <th className="text-left py-2 px-3 text-gray-500">Valeur reçue</th>
                    <th className="text-left py-2 px-3 text-gray-500">Raison</th>
                  </tr>
                </thead>
                <tbody>
                  {fichier.rapport.erreurs.map((erreur) => (
                    <tr key={erreur.id} className="border-b hover:bg-gray-50">
                      <td className="py-2 px-3 text-gray-600">{erreur.numeroLigne}</td>
                      <td className="py-2 px-3 font-medium text-red-600">{erreur.colonne}</td>
                      <td className="py-2 px-3 text-gray-600">{erreur.valeurRecue}</td>
                      <td className="py-2 px-3 text-gray-500">{erreur.raison}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
